...
public class EdgeMod extends SimpleFractal
{
	...
	protected Paint getForeground()
	{
		...
		RadialGradientPaint paint = new RadialGradientPaint((float)min.x, (float)min.y, (float)min.distance(max), dist, colors);
		return paint;
	}
	...
	protected void createBase()
	{
		...
		Rectangle square = new Rectangle(p1, p2, p3, p4, null, false);
		squares.add(square);
	...
	public static void main(String[] args)
	{
		...
		FractalPanel fractal = new FractalPanel(new EdgeMod());		
