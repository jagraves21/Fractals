...
public class RhombusFlake extends LSystem
{
	public RhombusFlake()
	{
		super();
	...
	{
		return new StringBuilder("-F++F[++F]--F[++F]--F[++F]--F[++F]--F[++F]--F");
	}
	...
	public static void main(String[] args)
	{
		...
		FractalPanel fractal = new FractalPanel(new RhombusFlake());		
