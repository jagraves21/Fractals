...
public class Squares extends SimpleFractal
{
	...
	protected void createBase()
	{
		...
		Rectangle rect = new Rectangle(p1,p2,p3,p4,colors[iteration%colors.length]);
	...
	public void next()
	{
		...
		while(iter.hasNext())
		{
			...
			nRect = new Rectangle(np1,np2,np3,np4,colors[iteration%colors.length]);
	...
	public static void main(String[] args)
	{
		...
		FractalPanel fractal = new FractalPanel(new Squares());		
