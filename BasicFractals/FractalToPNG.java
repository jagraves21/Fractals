...
public class FractalToPNG
{
	...
	{
		System.out.println("java FractalToPNG [-options] <class files>");
		System.out.println("  -w <numner>     specify the width of the png");
		System.out.println("  -h <numner>     specify the height of the png");
		System.out.println("  -i <numner>     iterations");
		System.out.println("");
		System.out.println("example:  java FractalToPNG -w 800 -h 500 -d 500 Dragon.class LevyCurve.class\n");
