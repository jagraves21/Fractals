...
public class PythagorasShrub extends SimpleFractal
{
	...
	protected final double threshold = sinAngle1 * (sinAngle1 * Math.sqrt(Math.pow(square_len,2)) / s45) / s45;
	...
	{
		MyPoint p1 = new MyPoint((WIDTH * (2.0/3.0))-(square_len/2), (HEIGHT * (3.0/4.0))-square_len);
		MyPoint p2 = new MyPoint((WIDTH * (2.0/3.0))+(square_len/2), (HEIGHT * (3.0/4.0))-square_len);
	...
	public static void main(String[] args)
	{
		...
		FractalPanel fractal = new FractalPanel(new PythagorasShrub());		
