...
public class PentaFlakeMod extends SimpleFractal
{
	...
	public void next()
	{
		...
		while(iter.hasNext())
		{
			...
			pent = new Pentagon(np1, np2, np3, np4, np5, null, true);
	...
	public static void main(String[] args)
	{
		...
		FractalPanel fractal = new FractalPanel(new PentaFlakeMod());		
