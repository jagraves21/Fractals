...
public class SquareTriangle extends SimpleFractal
{
	...
	protected void createBase()
	{
		...
		Rectangle rect = new Rectangle(p1,p2,p3,p4,null,true);
		squares.add(rect);
	}
	...
	public static void main(String[] args)
	{
		...
		FractalPanel fractal = new FractalPanel(new SquareTriangle());		
