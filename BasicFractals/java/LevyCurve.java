...
public class LevyCurve extends SimpleFractal
{
	...
	protected Paint getForeground()
	{
		...
		RadialGradientPaint paint = new RadialGradientPaint((float)mid.x, (float)mid.y, (float)mid.distance(tmp), (float)mid.x, (float)(mid.y/3.0), dist, colors, CycleMethod.NO_CYCLE);
		return paint;
	}
	...
	public static void main(String[] args)
	{
		...
		FractalPanel fractal = new FractalPanel(new LevyCurve());		
