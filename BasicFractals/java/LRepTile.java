...
public class LRepTile extends SimpleFractal
{
	...
	protected void createBase()
	{
		...
		MyPoint p3 = new MyPoint(WIDTH/2, HEIGHT/2);
		MyPoint p4 = new MyPoint(WIDTH, HEIGHT/2);
	...
	public static void main(String[] args)
	{
		...
		FractalPanel fractal = new FractalPanel(new LRepTile());		
