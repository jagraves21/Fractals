...
public class CircleLimitSet4 extends SimpleFractal {
	...
	protected void createBase() {
		...
		center1 =
				new Circle(
						new MyPoint(center.c.x, center.c.y - diff), center.radius() - diff, center.paint);
		center1.c =
				translate(
						center.c,
						center1.c,
						center.c.distance(center1.c),
						(2 * Math.PI) / getSuggestedIterations());

		center2 =
				new Circle(
						new MyPoint(center.c.x + diff, center.c.y), center.radius() - diff, center.paint);
		center2.c =
				translate(
						center.c,
						center2.c,
						center.c.distance(center2.c),
						(2 * Math.PI) / getSuggestedIterations());
	...
	public void next() {
		...
		Circle c1 =
				new Circle(new MyPoint(center.c.x, center.c.y - WIDTH - 10), center.radius(), Color.YELLOW);
		Circle c2 =
				new Circle(
						translate(center.c, c1.c, center.c.distance(c1.c), 1 * r60),
						center.radius(),
						new Color(239, 0, 222));
		Circle c3 =
				new Circle(
						translate(center.c, c1.c, center.c.distance(c1.c), 2 * r60),
						center.radius(),
						new Color(115, 0, 247));
		Circle c4 =
				new Circle(
						translate(center.c, c1.c, center.c.distance(c1.c), 3 * r60),
						center.radius(),
						new Color(0, 132, 255));
		Circle c5 =
				new Circle(
						translate(center.c, c1.c, center.c.distance(c1.c), 4 * r60),
						center.radius(),
						new Color(0, 239, 140)); // new Color(0, 239, 140));
		Circle c6 =
				new Circle(
						translate(center.c, c1.c, center.c.distance(c1.c), 5 * r60),
						center.radius(),
						new Color(0, 231, 0));
