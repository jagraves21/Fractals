...
public class CircleLimitSetNew extends SimpleFractal {
	...
	protected void createBase() {
		...
		Circle c2 =
				new Circle(
						translate(c.c, c1.c, c.c.distance(c1.c), 1 * (2 * Math.PI / 7)),
						c1.radius,
						new Color(255, 127, 0));
		...
		Circle c3 =
				new Circle(
						translate(c.c, c1.c, c.c.distance(c1.c), 2 * (2 * Math.PI / 7)),
						c1.radius,
						new Color(255, 255, 0));
		Circle c4 =
				new Circle(
						translate(c.c, c1.c, c.c.distance(c1.c), 3 * (2 * Math.PI / 7)),
						c1.radius,
						new Color(0, 255, 0));
		Circle c5 =
				new Circle(
						translate(c.c, c1.c, c.c.distance(c1.c), 4 * (2 * Math.PI / 7)),
						c1.radius,
						new Color(0, 0, 255)); // new Color(0, 239, 140));
		Circle c6 =
				new Circle(
						translate(c.c, c1.c, c.c.distance(c1.c), 5 * (2 * Math.PI / 7)),
						c1.radius,
						new Color(75, 0, 130));
		Circle c7 =
				new Circle(
						translate(c.c, c1.c, c.c.distance(c1.c), 6 * (2 * Math.PI / 7)),
						c1.radius,
						new Color(143, 0, 255));
