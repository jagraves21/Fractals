	...
	public ChristmasApollonianGasket() {
		...
		for (int ii = 1; ii < tmpCOLORS.length - 1; ii++) {
			int red =
					tmpCOLORS[0].getRed()
							- ii
									* ((tmpCOLORS[0].getRed() - tmpCOLORS[tmpCOLORS.length - 1].getRed())
											/ tmpCOLORS.length);
			int green =
					tmpCOLORS[0].getGreen()
							- ii
									* ((tmpCOLORS[0].getGreen() - tmpCOLORS[tmpCOLORS.length - 1].getGreen())
											/ tmpCOLORS.length);
			int blue =
					tmpCOLORS[0].getBlue()
							- ii
									* ((tmpCOLORS[0].getBlue() - tmpCOLORS[tmpCOLORS.length - 1].getBlue())
											/ tmpCOLORS.length);
